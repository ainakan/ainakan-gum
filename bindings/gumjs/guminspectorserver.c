                              ...
                              gpointer user_data)
{
  ...
  json_builder_add_string_value (builder, "Ainakan Agent");

  json_builder_set_member_name (builder, "url");
  json_builder_add_string_value (builder, "file://");

  json_builder_set_member_name (builder, "faviconUrl");
  json_builder_add_string_value (builder, "https://ainakan.re/favicon.ico");
                                 ...
                                 gpointer user_data)
{
  ...
  json_builder_add_string_value (builder, "Ainakan/v" AINAKAN_VERSION);
