import ainakan
from ainakan_tools.application import Reactor
...
class Controller:
    def __init__(self):
        ...
        self._runner_dylib = runner_src_dir.parent.parent.parent.parent / "build" / "tmp-macos-arm64" / "ainakan-gum" / "tests" / "core" / "swiftapiresolver" / "libtestswiftapiresolver.dylib"
    ...
    def _start(self):
        device = ainakan.get_remote_device()
        self._device = device
