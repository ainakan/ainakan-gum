...
"$repo/tools/symbolicate.py" \
  ...
  --declare-module $buildpfx/ainakan-core/lib/agent/libainakan-agent-modulated.dylib:$agent_base \
  --declare-module $buildpfx/ainakan-gum/tests/core/swiftapiresolver/libtestswiftapiresolver.dylib:$tests_base
