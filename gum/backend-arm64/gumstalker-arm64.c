                                  ...
                                  GumArm64Writer * cw)
{
   ...
   * to a 16-byte boundary when it is used to access memory. One anti-Ainakan
 ...
 * stack when it isn't 16-byte aligned. Anti-Ainakan techniques have been observed
 ...
 * made to load or store from a misaligned stack pointer, this anti-Ainakan code
 * can misalign the stack and cause a branch without accessing stack data and
 * hence therefore force AINAKAN to deal with a misaligned stack without
